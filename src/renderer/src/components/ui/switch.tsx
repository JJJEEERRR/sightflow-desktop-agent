...
/**
 * shadcn/ui Switch — copy-pasted from
 * https://ui.shadcn.com/docs/components/switch. Radix-backed accessible
 * toggle (rendered as `role="switch"`); replaces the native checkbox we
 * used pre-PR4 for booleans like `humanizer.enabled` /
 * `rateLimiter.enabled`.
 */

...
const translations = {
  zh: {
    ...
    'diag.export': '导出诊断包',
    'diag.export.aria': '导出诊断包（日志 + 配置 + 状态快照）',
    'diag.export.exporting': '导出中…',
    'diag.export.failed': '导出失败',
    'diag.export.label': '导出诊断包',
    'diag.export.success': '已导出诊断包至',
  ...
  en: {
    ...
    'diag.export.aria': 'Export diagnostic bundle (logs + config + state snapshot)',
    'diag.export.exporting': 'Exporting…',
    'diag.export.failed': 'Export failed',
    'diag.export.label': 'Export diagnostics',
    'diag.export.success': 'Diagnostics exported to',
